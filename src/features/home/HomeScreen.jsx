...
export function HomeDashboard({ programme, unfinishedWorkout, surgeryDate, trainingMode = "gym", today, showSessions, onStart, onContinue, onChooseSession, routineTasks = [], routineExpanded = false, onToggleRoutine, onRoutineStatus }) {
